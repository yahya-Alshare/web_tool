...
// إخفاء رمز التحميل بعد زمن محدد (بالمثال: 2 ثانية)
setTimeout(function() {
...
const enmenu = document.querySelector(".menu-content ");
const hederenmenue = document.querySelector(".menu-content h2").innerHTML = "Related services and tools";

if(enmenu){
  const enmenu = document.querySelector(".menu-content");
const children = enmenu.children;
// Map of Arabic menu items and their corresponding English text
const menuTranslations = {
  "حساب ضريبة القيمة المضافة": "VAT Calculator",
  "اسعار صرف العملات اليوم": "Currency Exchange Rates",
  "تحويل العملات - محول العملات": "Currency Converter",
  "سعر الذهب اليوم": "Gold Price Today",
  "سعر الذهب اليوم عيار 21 الآن": "Gold Price Today 21K",
  "حساب CBM حجم الشحنة التجارية": "CBM Calculator",
  "حساب النسبة المئوية": "Percentage Calculator",
  "حساب النسبة المئوية بين رقمين أو أكثر": "Percentage Calculator for Multiple Numbers",
  "حساب النسبة المئوية من مبلغ": "Percentage Calculator from Amount",
  "حساب الخصم - معرفة السعر قبل وبعد الخصم": "Discount Calculator - Pre & Post Discount Price",
  "حساب الجذر التربيعي": "Square Root Calculator",
  "حساب الوسط الحسابي": "Arithmetic Mean Calculator",
  "الة حاسبة": "Calculator",
  "حساب زكاة المال": "Zakat Calculator",
  "تحديد حجم العينة في البحث العلمي": "Sample Size Calculator",
  "تفقيط عملات ومبالغ مالية": "Number to Text Currency Converter",
  "تحويل الأرقام إلى كلمات": "Number to Text Converter",
  "تحويل الأرقام العربية إلى أرقام انجليزية": "Arabic to English Number Converter",
  "تحويل الأرقام الإنجليزية إلى أرقام عربية": "English to Arabic Number Converter",
  "تكرار نص": "Text Repeater",
  "تحويل الطول - محول الطول": "Length Converter",
  "تحويل الوزن - محول الوزن": "Weight Converter",
  "تحويل الحرارة فهرنهايت أو مئوي أو كلفن": "Temperature Converter",
  "حاسبة الطابو - حساب مساحة حصتك من القوشان": "Tapu Calculator - Calculate Your Plot Area",
  "عرض كافة الخدمات": "View All Services",
  "قياس سرعة النت":"Measure internet speed",
  "انشاء QR Code":"Create a QR Code",
  "انشاء باركود Barcode":"Create a barcode",
  "تحويل الرابط الى باركود":"Convert the link into a barcode",
  "تصغير حجم الصور":"Reduce the size of the images",
  "عنوان IP الخاص بك":"Your IP address",
  "دقة الشاشة الخاصة بك":"your screen resolution",
  "ارسال رسالة واتساب لرقم غير مسجل لديك":"Send a WhatsApp message to a number not registered with you",
  "ارسال رسالة واتساب لمجموعة ارقام غير مسجلة لديك":"Send a WhatsApp message to a group of numbers not registered with you",
  "انشاء رابط واتساب":"Create a WhatsApp link",
  "لعبة تحدي الجمع في الرياضيات":"Math addition challenge game",
  "حساب سن وتاريخ التقاعد للموظفين":"Calculate the age and date of retirement for employees",
  "حساب اجر الساعة من الراتب الشهري":"Calculate the hourly wage from the monthly salary",
  "حساب اجر اليوم من الراتب الشهري":"Calculate today's wages from the monthly salary",
  "حاسبة اجر الساعة الاضافية - اوفر تايم":"Overtime hourly wage calculator",
  "كم باقي على الراتب":"How much is left in the salary?",
  "رواتب المتقاعدين - السعودية":"Pensioners' salaries - Saudi Arabia",
  "موعد نزول حافز - السعودية":"The date of the release of the incentive - Saudi Arabia",
  "سعر سهم ارامكو اليوم":"Aramco share price today",
  "حساب العمر": "Calculate Age",
  "حساب فرق العمر بين شخصين": "Calculate Age Difference Between Two People",
  "تحديد الابراج بتاريخ الميلاد": "Determine Zodiac Signs by Birthdate",
  "تاريخ اليوم - تاريخ هجري وميلادي": "Today's Date - Hijri and Gregorian Date",
  "تاريخ اليوم بالإنجليزية": "Today's Date in English",
  "تاريخ اليوم ميلادي": "Today's Gregorian Date",
  "تاريخ اليوم هجري": "Today's Hijri Date",
  "تاريخ امس - تاريخ هجري وميلادي": "Yesterday's Date - Hijri and Gregorian Date",
  "الشهر الآن - شهر كم ميلادي وهجري": "Current Month - Gregorian and Hijri Month",
  "شهر كم ميلادي": "Current Gregorian Month",
  "شهر كم هجري": "Current Hijri Month",
  "محول التاريخ": "Date Converter",
  "تحويل التاريخ من ميلادي الى هجري": "Convert Gregorian Date to Hijri",
  "تحويل التاريخ من هجري الى ميلادي": "Convert Hijri Date to Gregorian",
  "حساب الفرق بين تاريخين بالميلادي": "Calculate Date Difference in Gregorian Dates",
  "حساب الفرق بين تاريخين بالهجري": "Calculate Date Difference in Hijri Dates",
  "حساب المدة بين وقتين": "Calculate Duration Between Two Times",
  "اضافة مدة إلى وقت وتاريخ": "Add Period to Date and Time",
  "طرح مدة من وقت وتاريخ": "Subtract Period from Date and Time",
  "عداد الايام - حساب عدد الايام المتبقية": "Days Counter - Calculate Remaining Days",
  "حساب الوزن المثالي وكتلة الجسم BMI": "Calculate Ideal Weight and Body Mass Index (BMI)",
  "حساب السعرات الحرارية": "Calculate Calorie Intake",
  "حساب الحمل وموعد الولادة": "Calculate Pregnancy and Due Date",
  "حساب الحمل بالهجري": "Calculate Pregnancy in Hijri Calendar",
  "حساب الدورة الشهرية": "Calculate Menstrual Cycle",
  "حساب ايام التبويض": "Calculate Ovulation Days",
  "حساب النسبة الموزونة": "Weighted Average Calculator",
  "تحويل المعدل التراكمي من 4 إلى 100": "Convert GPA 4 to 100",
  "حساب المعدل التراكمي من 4 لطلبة الجامعات": "GPA Calculator for University Students (GPA 4 Scale)",
  "حساب المعدل التراكمي من 5": "GPA Calculator (GPA 5 Scale)",
  "حساب المعدل التراكمي - حساب المعدل الجامعي": "GPA Calculator - University GPA Calculator",
  "حساب المعدل التراكمي - الجامعة العربية الأمريكية جنين": "GPA Calculator - Arab American University Jenin",
  "حساب المعدل التراكمي - جامعة النجاح الوطنية": "GPA Calculator - An-Najah National University",
  "حساب المعدل التراكمي - الجامعة الأردنية": "GPA Calculator - University of Jordan",
...
// Loop through each menu link and replace the text with English if a translation exists
menuLinks.forEach(function(link) {
  const arabicText = link.textContent.trim();
  const englishText = menuTranslations[arabicText];
