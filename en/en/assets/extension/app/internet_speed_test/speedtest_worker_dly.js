...
var settings = {
	test_order: "D___U___P", //order in which tests will be performed as a string. D=Download, U=Upload, P=Ping+Jitter, I=IP, _=1 second delay
	time_ul_max: 25, // max duration of upload test in seconds
	time_dl_max: 25, // max duration of download test in seconds
	...
	url_dl: "https://1.speedtestserver.net/garbage.php", // path to a large file or garbage.php, used for download test. must be relative to this js file
	url_ul: "https://1.speedtestserver.net/empty.php", // path to an empty file, used for upload test. must be relative to this js file
	url_ping: "https://1.speedtestserver.net/empty.php", // path to an empty file, used for ping test. must be relative to this js file
	url_getIp: "https://1.speedtestserver.net/getIP.php", // path to getIP.php relative to this js file, or a similar thing that outputs the client's ip
	...
	url_telemetry: "https://1.speedtestserver.net/telemetry/telemetry.php", // path to the script that adds telemetry data to the database
